...
const FilterBar: React.FC<FilterBarProps> = ({ customers, statusOptions, filters, onFilterChange, onReset }) => {
    return (
        <div className="bg-white dark:bg-slate-800 p-4 rounded-lg border border-slate-200 dark:border-slate-700 mb-6 flex flex-wrap items-center gap-4 text-sm">
            ...
            <div className="flex-grow min-w-[150px]">
                ...
                <select
                    ...
                    className="w-full bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded-md text-slate-900 dark:text-slate-100 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition duration-300 appearance-none"
            ...
            <div className="flex-grow min-w-[120px]">
                ...
                <input
                    ...
                    className="w-full bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded-md text-slate-900 dark:text-slate-100 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition duration-300"
