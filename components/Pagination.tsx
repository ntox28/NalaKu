            ...
            pages.push(
                <button
                    ...
                    className={`px-3 py-1 mx-1 rounded-md transition-colors text-xs sm:text-sm ${
                        currentPage === i ? 'bg-orange-600 text-white font-bold' : 'text-slate-600 dark:text-slate-300 bg-white dark:bg-slate-800 hover:bg-slate-100 dark:hover:bg-slate-700'
                    }`}
                >
                    {i}
                </button>
